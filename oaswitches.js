(function() {
	...
	(window.getSwitchList = function() {
		...
		if (url.indexOf('app=Int;action=paint_co_sw') > -1 ) {
			...
			content += "</tbody></table>";
			content += "<table class='table table-condensed table-bordered error-log'><thead><tr><th>Script error log</th>";
