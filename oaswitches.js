		...
		if (url.indexOf('app=Int;action=paint_co_sw') > -1 ) {
			...
			for (var i=0;i<switchArray.length;i++) {
				...
				if (label != "-BLANK-") {
					...
					content += "<tr><td>" + counter + "</td><td>" + label + "</td><td>" + value + "</td></tr>";
					counter++;
				}
			}
